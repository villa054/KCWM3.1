...
public class Exhibit2 extends AppCompatActivity implements GestureDetector.OnGestureListener,
        ...
        public void onClick(View v) {
            if (v.equals(startMedia)) {
                ...
                if (audio == null) {
                    audio = MediaPlayer.create(getApplicationContext(), R.raw.script1area2);
        ...
        public void onSwipeLeft() {
            ...
            Intent myIntent = new Intent(Exhibit2.this, Exhibit2b.class);
            Exhibit2.this.startActivity(myIntent);
            if(audio != null) {
                audio.release();
            }
            finish();
